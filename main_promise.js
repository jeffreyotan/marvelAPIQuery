// we will use promises in this version instead of async-await
...
app.get('/', (req, res, next) => {
    ...
    fetch(Marvel_Query_Character_List(timeStamp, PUB_API_KEY, PRI_API_KEY))
        ...
        .then(result => {
            if(result.data.count <= 0)
                ...
                res.render('index', { character: result.data.results });
            }
        })
        .catch(e => {
